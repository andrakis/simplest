...
// Generated by CoffeeScript 1.4.0
(function() {
  var SuperClass, clone, moduleKeywords,
    __indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; };
  ...
  SuperClass = (function() {
    ...
    SuperClass.include = function(obj, extendedModuleKeywords) {
      ...
      for (key in _ref) {
        value = _ref[key];
        if (__indexOf.call(moduleKeywords, key) < 0 && __indexOf.call(extendedModuleKeywords, key) < 0) {
...
// Wrap.js, for util/events
ref = (function(require, exports, module) {
	if (0) console.log("Creating ref for util/events");

// Generated by CoffeeScript 1.4.0
(function() {
  var Events, SuperClass, vlog,
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

  vlog = require('verbosity').vlog;

  SuperClass = require('tc_util').SuperClass;
  ...
  Events = (function(_super) {
    ...
    Events.prototype.event = function(name, description) {
      if (this.events_info[name] != null) {
        throw "Event " + name + " already registered";
      }
      return this.events_info[name] = description;
    };

    Events.prototype.event_delayed_binding = function(name) {
      this.events_pending[name] = this.events_pending[name] || [];
    };

    Events.prototype.on = function(event, callback) {
      this.events[event] = this.events[event] || [];
      this.events[event].push(callback);
      this._fire_pending(event, callback);
    };

    Events.prototype.fire = function() {
      var args, callbacks, cb, event, _i, _len;
      args = Array.prototype.slice.call(arguments);
      event = args.shift();
      if (!event) {
        throw 'event required';
      }
      if (this.events_pending[event] != null) {
        this.events_pending[event].push(args);
      }
      callbacks = this.events[event] || [];
      for (_i = 0, _len = callbacks.length; _i < _len; _i++) {
        cb = callbacks[_i];
        this._fire_callback(cb, args);
      }
    };

    Events.prototype._fire_pending = function(event, callback) {
      var args, pending, _i, _len;
      pending = this.events_pending[event] || [];
      for (_i = 0, _len = pending.length; _i < _len; _i++) {
        args = pending[_i];
        this._fire_callback(callback, args);
      }
      this.events_pending[event] = [];
    };

    Events.prototype._fire_callback = function(callback, args) {
      var context;
      context = {};
...
// Wrap_post.js, for util/events
	return exports;
});

if( modules ) {
	if (0) console.log("Registering util/events");
	var namespace = {test:1};
	var ex = {ex: 1};
	var module = {mod: 1};
	var ex_obtain = function(path) {
		if (0) console.log("obtain from util/events");
		return obtain(path);
	};
	res = ref.call(namespace, ex_obtain, ex, module);
	if (0) console.log("Res is", res);
	modules['util/events'] = module.exports;
	if (0) console.log("Namespace is", namespace);
	if (0) console.log("Exports is", ex);
	if (0) console.log("Registered util/events as", modules['util/events']);
} else {
	if (0) console.log("Standard export");
	ref(require, exports);
}
...
// Generated by CoffeeScript 1.4.0
(function() {
  var CPU_FEATURE_VAR, DumpObjectFlat, FEATURE_CLASS, FEATURE_NAME, Feature, Options, StackTrace, SuperClass, clone, decSymbol, exports, feature_cache, get_features, register_feature, vlog, _ref,
    __indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
  ...
  _ref = require('tc_util'), StackTrace = _ref.StackTrace, clone = _ref.clone, DumpObjectFlat = _ref.DumpObjectFlat, SuperClass = _ref.SuperClass;
...
// Generated by CoffeeScript 1.4.0
(function() {
  var Buffer, Events, SuperClass, clone, decSymbol, vlog, _ref,
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
  ...
  _ref = require('tc_util'), clone = _ref.clone, SuperClass = _ref.SuperClass;
  ...
  Buffer = (function(_super) {
    ...
    Buffer.include(Events);

    function Buffer() {
      Events.call(this);
      this.event('read', "Whenever content is checked for and read from the buffer");
      this.event('write', "Whenever content is written to the buffer");
      this.event('switch', "Whenever the buffer is switched");
      this.event('flush', "Whenever the buffer is flushed");
      this.event('flush_noclear', "Called internally by flush, or by flush_noclear");
      this.reset();
    }
    ...
    Buffer.prototype.flush_noclear = function(max, mapper, reducer) {
      var final, length, result, v;
      length = 0;
      result = [];
      ...
      this.fire('flush_noclear', final);
      return final;
    };

    Buffer.prototype.flush = function(max, mapper, reducer) {
      var result;
      result = this.flush_noclear(max, mapper, reducer);
      this.reset;
      return result;
    };
    ...
    Buffer.prototype.on_read = function(callback) {
      return this.on('read', callback);
    };

    Buffer.prototype.on_write = function(callback) {
      return this.on('write', callback);
    };

    Buffer.prototype.on_flush = function(callback) {
      return this.on('flush', callback);
    };

    Buffer.prototype.on_flush_noclear = function(callback) {
      return this.on('flush_noclear', callback);
    };

    Buffer.prototype.on_switch = function(callback) {
      return this.on('switch', callback);
    };

    Buffer.prototype["switch"] = function(dest, supress_copy) {
      vlog(50, "Switching buffer to", dest);
      if (!supress_copy) {
        vlog(50, " Copying buffer contents");
        dest.reset();
        dest.buffer = clone(this.buffer);
        dest.pos = this.pos;
      }
      return dest;
    };

    Buffer.prototype._rangecheck = function() {
...
// Wrap.js, for server
ref = (function(require, exports, module) {
	if (0) console.log("Creating ref for server");

// Generated by CoffeeScript 1.4.0
(function() {
  var Buffer, Events, SuperClass, TELNET_SERVER_PORT, TELNET_VERB, TelnetClient, TelnetInterface, clients, log, net, server_socket,
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
  ...
  TelnetClient = (function(_super) {

    __extends(TelnetClient, _super);

    TelnetClient.include(Events);

    function TelnetClient(stream) {
      var self;
      log(30, "New TelnetClient");
      Events.call(this);
      this.stream = stream;
      this.stream_closed = false;
      this.event('open', "When the connection opens");
      this.event('data', "When a command is received from the client");
      this.event('close', "When a client disconnects");
      self = this;
      ...
      this.event_delayed_binding('open');
      this.fire('open', stream);
    }

    TelnetClient.prototype.write = function(data) {
  ...
  TelnetInterface = (function(_super) {

    __extends(TelnetInterface, _super);

    TelnetInterface.include(Events);

    function TelnetInterface(client) {
      var self;
      Events.call(this);
      this.commands = {};
      this.client = client;
      ...
      client.on('open', function() {
        return self.on_open.apply(self, arguments);
      });
      client.on('data', function() {
        return self.on_data.apply(self, arguments);
      });
      client.on('close', function() {
        return self.on_close.apply(self, arguments);
      });
      this.command('help', function() {
        ...
        this.write(((function() {
          ...
          _results = [];
          for (cmd in _ref) {
            if (!__hasProp.call(_ref, cmd)) continue;
            _results.push(cmd);
          }
          return _results;
        }).call(this)).join(','));
      ...
      this.command('shutdown', function() {
        this.write("Requesting shutdown");
        return setTimeout(function() {
          server.close();
          return server_socket.destroy();
        }, 1);
      });
      log(30, "New TelnetInterface");
    }

    TelnetInterface.prototype.write = function(data) {
      return this.client.write(data);
    };

    TelnetInterface.prototype.prompt = function() {
      return this.write("\n] ");
    };

    TelnetInterface.prototype.command = function(name, regex, callback) {
      if (this.commands[name] != null) {
        throw "Command " + name + " already defined";
      }
      if (!callback && typeof regex === 'function') {
        callback = regex;
        regex = null;
      } else {
        if (this.commands[regex] != null) {
          throw "Regex " + regex + " already defined";
        }
        this.commands[regex] = callback;
      }
      this.commands[name] = callback;
    };

    TelnetInterface.prototype.on_open = function(stream) {
      this.write("Welcome to the Simplest Telnet Server\n");
      this.prompt();
    };

    TelnetInterface.prototype.on_data = function(data) {
      var callback, isRegExp, isRegExpCheck, match, regex, success, _ref;
      data = data.toString();
      success = false;
    ...
    TelnetInterface.prototype.on_close = function() {};

    return TelnetInterface;

  })(SuperClass);

  server_socket = void 0;
  ...
  exports.test = function() {
    ...
    server = net.createServer(function(stream) {
      ...
      return int = new TelnetInterface(client);
    });
    server.on('connection', function(socket) {
      return server_socket = socket;
    });
    server.listen(TELNET_SERVER_PORT);
    return console.log("Waiting for connection on port " + TELNET_SERVER_PORT);
  };
...
// Wrap_post.js, for server
	return exports;
});

if( modules ) {
	if (0) console.log("Registering server");
	var namespace = {test:1};
	var ex = {ex: 1};
	var module = {mod: 1};
	var ex_obtain = function(path) {
		if (0) console.log("obtain from server");
		return obtain(path);
	};
	res = ref.call(namespace, ex_obtain, ex, module);
	if (0) console.log("Res is", res);
	modules['server'] = module.exports;
	if (0) console.log("Namespace is", namespace);
	if (0) console.log("Exports is", ex);
	if (0) console.log("Registered server as", modules['server']);
} else {
	if (0) console.log("Standard export");
	ref(require, exports);
}
